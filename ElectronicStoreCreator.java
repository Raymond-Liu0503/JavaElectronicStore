public class ElectronicStoreCreator{
  public static ElectronicStore createStore1(){
    ...
    Oven t2 = new Oven(75, 10, 50, "Silver", "Toasty", true);
  ...
  public static ElectronicStore createStore2(){
    ...
    Oven t1 = new Oven(25, 10, 50, "Graphite", "Danby", false);
    Oven t2 = new Oven(75, 10, 50, "Red", "Toasty",  true);
    store1.addProduct(d1);
    store1.addProduct(d2);
    store1.addProduct(l1);
    store1.addProduct(l2);
  ...
  public static ElectronicStore createStore3(){
    ...
    Oven t1 = new Oven(30, 10, 50, "Graphite", "Danby", false);
    Oven t2 = new Oven(80, 10, 50, "Red", "Toasty",  true);
    ...
    Oven t3 = new Oven(30, 10, 50, "Graphite", "Danby", false);
    Oven t4 = new Oven(80, 10, 50, "Red", "Toasty", true);
    store1.addProduct(d1);
    store1.addProduct(d2);
    store1.addProduct(l1);
    store1.addProduct(l2);
